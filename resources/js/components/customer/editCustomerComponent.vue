            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="login-form">
                  ...
                  <form class="user" @submit.prevent="handleCustomerUpdate" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                          ...
                          <div class="form-group">
                              <div class="form-row">
                                  <div class="col-md-6">
                                      <input type="text" v-model="form.address" class="form-control" id="inputaddress"
